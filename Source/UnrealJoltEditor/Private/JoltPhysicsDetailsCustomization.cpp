...
void FJoltPhysicsDetailsCustomization::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
	...
	AddGroup(FName("Motion"), { GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, MotionType), GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, AllowedDOFs), GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, Layer), GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, Mass) });
	AddGroup(FName("Forces"), { GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, GravityFactor), GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, bApplyGyroscopicForce), GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, MaxLinearVelocity), GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, MaxAngularVelocity) });
	AddGroup(FName("Surface"), { GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, Friction), GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, Restitution) });
	AddGroup(FName("Damping"), { GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, LinearDamping), GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, AngularDamping) });
	AddGroup(FName("Advanced"), { GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, bAllowSleeping), GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, NumVelocityStepsOverride), GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, NumPositionStepsOverride), GET_MEMBER_NAME_CHECKED(UJoltPhysicsComponent, bEnhancedInternalEdgeRemoval) });
}